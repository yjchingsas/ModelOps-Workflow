data sasep.out;
   ...
   in_out varchar(100) "I_Default");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_342b63dd-25a4-4324-95e1-835fc54fba46', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_342b63dd-25a4-4324-95e1-835fc54fba46');
