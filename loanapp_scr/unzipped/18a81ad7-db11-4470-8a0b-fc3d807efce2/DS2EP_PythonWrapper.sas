data sasep.out;
   ...
   in_out varchar(100) "I_Default");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_23fe0fc0-c4f8-42b5-a4bf-7008f60a56c6', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_23fe0fc0-c4f8-42b5-a4bf-7008f60a56c6');
