ds2_options sas tkgmac scond=none;
 ...
 method score(double "CredLineAge", double "Delinquencies", double "DerogatoryMarks", 
in_out double "_leaf_id_", in_out double "_numval_", in_out char(12) "EM_CLASSIFICATION", 
