...
in_out varchar(100) "I_Default");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_2a32def3-26ca-476f-9030-75d835fe09fe', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import _4eciaroqodklgq7s8o0p6y4r5_3b034f75_83ec_4337_8316_1d2b0f926206');
         ...
         resultCode = pm.appendSrcLine('    return _4eciaroqodklgq7s8o0p6y4r5_3b034f75_83ec_4337_8316_1d2b0f926206.score_method(Delinquencies, DerogatoryMarks, Inquiries, JobType, CredLineAge, CredLines, DebtIncRatio, LoanRequest, HomeValue, Income, LoanToValue, YearsOnJob)');

         revision = pm.publish(pm.getSource(), 'model_exec_2a32def3-26ca-476f-9030-75d835fe09fe');
