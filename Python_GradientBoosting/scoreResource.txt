data sasep.out;
   ...
   in_out varchar(100) "I_Default");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_2043750c-3b8b-4a82-92eb-5624bda6caa2', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_2043750c-3b8b-4a82-92eb-5624bda6caa2');
