...
in_out double "P_Default1");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_d581588d-7722-4123-9497-26fae8a9546c', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import _4eciaroqodklgq7s8o0p6y4r5_2dbcfc33_f8a2_4233_b9a2_3f26f72dd1e3');
         ...
         resultCode = pm.appendSrcLine('    return _4eciaroqodklgq7s8o0p6y4r5_2dbcfc33_f8a2_4233_b9a2_3f26f72dd1e3.score_method(Delinquencies, DerogatoryMarks, Inquiries, JobType, CredLineAge, CredLines, DebtIncRatio, LoanRequest, HomeValue, Income, LoanToValue, YearsOnJob)');

         revision = pm.publish(pm.getSource(), 'model_exec_d581588d-7722-4123-9497-26fae8a9546c');
